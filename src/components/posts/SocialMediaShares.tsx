            ...
            <div class="flex justify-center">
                <div id={ 'socialsBtns' + props.id } class="share-btns grid grid-cols-4 md:grid-cols-2 gap-4 auto-rows-min">
                    <div id="x-share" class="socialBtn">
                        <button id="button--x" class="x-share-button z-30 flex justify-start items-center rounded font-bold text-icon1 dark:text-icon1-DM" title="Share to X - LANG!" onclick={ (e) => xShare(e) }>
                    ...
                    <div id="facebook-share" class="socialBtn">
                        ...
                        <p class="hidden md:inline text-xs text-ptext2 dark:text-ptext2-DM">Facebook</p>
                    </div>
                    ...
                    <div id="whatsapp-share" class="socialBtn">
                        ...
                        <p class="hidden md:inline text-xs">WhatsApp</p>
                    </div>
                    ...
                    <div id="email-share" class="socialBtn">
                        ...
                        <p class="hidden md:inline text-xs">Email</p>
                    </div>
                    ...
                    <div id="link-share" class="socialBtn">
                        ...
                        <p class="hidden md:inline text-xs">Copy Link</p>
                    </div>
                    ...
                    <div id="embed-share" class="socialBtn">
                        ...
                        <p class="hidden md:inline text-xs">Embed Link</p>
                    </div>
                    ...
                    <div id="text-share" class="socialBtn">
                        ...
                        <p class="hidden md:inline text-xs">Text Link</p>
                    </div>
                </div>
            </div>
