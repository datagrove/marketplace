export const French = {
  ...
  pageDescriptions: {
    ...
    viewClientAccount: "Accédez et gérez les informations de votre compte client sans effort sur TodoServis.",
    ...
    createProviderAccount: "Créez un compte fournisseur pour commencer à publier vos services sur TodoServis",
    viewProviderAccount: "Gérez les détails de votre compte fournisseur et consultez vos publications sur TodoServis.",
    clientViewProviderAccount: "Découvrez-en davantage sur ce fournisseur. Explorez leur profil et les services disponibles.",
    page404: "404 Page non trouvée",
    requestPasswordReset: "Mot de passe oublié? Demandez une réinitialisation sécurisée du mot de passe pour votre compte TodoServis. Entrez votre email et suivez les instructions pour retrouver l'accès.",
  ...
  messages: {
    ...
    noEdit: "Pour mettre à jour ou modifier le contenu de la publication, vous devez supprimer la publication obsolète et en créer une nouvelle.",
  },
