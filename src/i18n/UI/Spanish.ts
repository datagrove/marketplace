export const Spanish = {
  ...
  pageDescriptions: {
    ...
    viewClientAccount: "Acceda y administre la información de su cuenta de cliente sin esfuerzo en TodoServis.",
    ...
    createProviderAccount: 'Cree una cuenta de proveedor para comenzar a publicar sus servicios en TodoServis',
    viewProviderAccount: "Administre los detalles de su cuenta de proveedor y revise sus publicaciones en TodoServis.",
