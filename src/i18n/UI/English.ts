export const English = {
  ...
  pageDescriptions: {
    ...
    viewClientAccount: "Access and manage your client profile information effortlessly on TodoServis.",
    createPost: 'Create a post including title, category, description, location, and images to offer your service on TodoServis.',
    createProviderAccount: 'Create a Provider Profile to start posting your services on TodoServis.',
    viewProviderAccount: 'Manage your provider profile details and review your posts on TodoServis.',
  ...
  messages: {
    ...
    viewProviderAccount: "You do not have a provider profile. Please create one to view your provider profile.",
